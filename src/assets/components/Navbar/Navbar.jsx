  ...
  return (
    <nav className="main-navbar">
        <ul className="nav-menu">
          ...
          <li className="nav-item">
            <NavLink to="/ProductAdmin" className={({ isActive }) => isActive ? "active nav-link" : "nav-link"}>Adm. Productos</NavLink>
          </li>
          <li className="nav-item">
            <NavLink to="/user-admin" className={({ isActive }) => isActive ? "active nav-link" : "nav-link"}>Adm. Usuarios</NavLink>
          </li>
          <li className="nav-item">
